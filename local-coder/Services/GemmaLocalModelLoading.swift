...
nonisolated struct LocalDownloader: MLXLMCommon.Downloader {
  func download(
    id: String,
    revision: String?,
...
nonisolated struct LocalTokenizerLoader: MLXLMCommon.TokenizerLoader {
...
nonisolated struct LocalTokenizer: MLXLMCommon.Tokenizer {
