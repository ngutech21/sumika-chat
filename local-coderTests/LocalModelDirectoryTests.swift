...
struct LocalModelDirectoryTests {
    ...
    func readContextTokenLimitReadsKnownTopLevelKeys() throws {
        let modelDirectory = try makeTemporaryModelDirectory(configJSON: #"{"max_position_embeddings":4096}"#)
    ...
    func readContextTokenLimitReadsNestedKnownKeys() throws {
        let modelDirectory = try makeTemporaryModelDirectory(configJSON: #"{"text_config":{"max_seq_len":8192}}"#)
