...
actor GemmaDebugTraceStore: TurnTracing {
  ...
  func traceTurnEvent(_ event: TurnTraceEvent) {
    ...
    let optionalFields: [(String, Any?)] = [
      ...
      ("reusedPrefixTokens", event.reusedPrefixTokens),
      ("suffixTokens", event.suffixTokens),
      ...
      ("mlxActiveMemoryBytesBeforePrefill", event.mlxActiveMemoryBytesBeforePrefill),
      ("mlxCacheMemoryBytesBeforePrefill", event.mlxCacheMemoryBytesBeforePrefill),
      ("mlxPeakMemoryBytesBeforePrefill", event.mlxPeakMemoryBytesBeforePrefill),
      ("mlxActiveMemoryBytesAfterPrefill", event.mlxActiveMemoryBytesAfterPrefill),
      ("mlxCacheMemoryBytesAfterPrefill", event.mlxCacheMemoryBytesAfterPrefill),
      ("mlxPeakMemoryBytesAfterPrefill", event.mlxPeakMemoryBytesAfterPrefill),
      ("mlxActiveMemoryBytesAfterGeneration", event.mlxActiveMemoryBytesAfterGeneration),
      ("mlxCacheMemoryBytesAfterGeneration", event.mlxCacheMemoryBytesAfterGeneration),
      ("mlxPeakMemoryBytesAfterGeneration", event.mlxPeakMemoryBytesAfterGeneration),
